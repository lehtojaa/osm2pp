...
-- changed from the original format (us/international) to format more suitable for finnish addresses
function get_address(tags)
    ...
    if housenumber ~= nil and street ~= nil then
        housenumber_street = street  .. ' ' .. housenumber
	...
	local all_but_city_state = ''
	
	if housenumber_street ~= '' and postcode ~= '' then
		all_but_city_state = housenumber_street .. ', ' .. postcode
	else
		all_but_city_state = housenumber_street .. postcode
	end
	...
	if all_but_city_state ~= '' and city ~= '' then 
		all_but_state = all_but_city_state .. ', ' .. city 
	else all_but_state = all_but_city_state .. city 
	end
